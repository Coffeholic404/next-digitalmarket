...
const perks = [
  {
    ...
    description: 'Get your assets delivered to your emil in seconds and download them right away'
  },
  {
      ...
      <MaxWidthWrapper>
        <div className=" py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className=" mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome To DigitalMarket. Every Asset on our platform is verified by our team to ensure our highest quality standards.
          </p>
              ...
              <div key={perk.name} className="text-center md:flex md:items-start md:text-left lg:block lg:text-center ">
                <div className=" md:flex-shrink-0 flex justify-center">
                  <div className=" h-16 w-16 items-center  justify-center rounded-full bg-blue-100 text-blue-900 ">
                    {<perk.Icon className=" w-1/3 h-1/3 my-5  mx-auto"/>}
                  </div>
                </div>
